  ...
  return (
    <div>
        ...
        <Link href={`/product/${product.slug}`}>
            <a>
            <Image src = {product.picture} height="200" width = "150" alt ={product.name} />
            </a>
        </Link>
        </div>
         ...
         <h1 className='font-bold text-sm lg:text-base'>{product.name}</h1>
            ...
            <div className='flex justify-between pt-4'>
                ...
                <div>
                    <button className='font-extrabold h-5 w-5 rounded-md bg-rose-600 text-white text-sm'>+</button>
                </div>
            </div>
         </div>
        </div>

          ...
          {cart.cartItems.map((item) => (
            <div key={item.slug} item={item} className='flex gap-5 py-2'>
              ...
              <div className='flex flex-col justify-between'>
                ...
                <div className='flex'>
                  <span
                    ...
                    className='border p-2 rounded-lg border-rose-500'
                  >
                    <AiOutlineMinus />
                  </span>
                  ...
                  <span
                    ...
                    className='border p-2 rounded-lg bg-rose-400'
                  >
                    <AiOutlinePlus />
                  </span>
                </div>
              ...
              <div className='pl-14 flex flex-col justify-between'>
                ...
                <span onClick={() => removeCartItem(item)} className='px-1'>
          ...
          <div className='absolute bottom-10 flex flex-col pt-4 z-10'>
            ...
            <div className='py-6'>
              <button
                ...
                className='h-9 w-80 rounded-lg bg-rose-600 font-bold text-white text-center'
              >
                Check Out
              </button>
            </div>
